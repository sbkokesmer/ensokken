                ...
                <div className="p-6 flex flex-col gap-6">
                  <div className="grid grid-cols-3 gap-3">
                    <div className="bg-[#0f0f0f] rounded-xl p-3 text-center">
                      <p className="text-[#f24f13] text-lg font-semibold">{selected.orderCount}</p>
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-3">
                      <ShoppingCart width={14} height={14} className="text-[#f24f13]" />
                    ...
                    {selected.cartItems.length === 0 ? (
                      ...
                      <div className="flex flex-col gap-2">
                        {selected.cartItems.map((item) => (
                          <div key={item.id} className="bg-[#0f0f0f] rounded-xl px-4 py-3 flex items-center justify-between">
                            <div>
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-3">
                      <Heart width={14} height={14} className="text-[#f24f13]" />
                    ...
                    {selected.favorites.length === 0 ? (
                      ...
                      <div className="flex flex-col gap-2">
                        {selected.favorites.map((fav) => (
                          <div key={fav.id} className="bg-[#0f0f0f] rounded-xl px-4 py-3 flex items-center justify-between">
