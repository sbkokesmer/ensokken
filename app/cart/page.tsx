...
import { ArrowLeft, Truck, ShoppingBag, ArrowRight, Trash2 } from "lucide-react";
import { FREE_SHIPPING_THRESHOLD } from "@/lib/types";

export default function CartPage() {
  const { cart, updateQuantity, removeFromCart, subtotal, shippingCost, total, cartCount } = useCart();
            ...
            <div className="bg-white p-6 rounded-2xl border border-black/5 flex items-center gap-5 shadow-sm">
              ...
              <div className="flex-1">
                <div className="flex justify-between text-sm font-medium mb-2">
                  <span className="text-black">Verzending</span>
                  {remainingForFreeShipping > 0 ? (
                    <span className="text-zinc-400">Nog €{remainingForFreeShipping.toFixed(2)} voor gratis verzending</span>
                  ) : (
          ...
          <div className="lg:w-[26rem] shrink-0">
            <div className="bg-white p-8 rounded-[2.5rem] border border-black/5 sticky top-24 shadow-sm">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex justify-between text-zinc-600 text-base"><span>Subtotaal</span><span>€{subtotal.toFixed(2)}</span></div>
