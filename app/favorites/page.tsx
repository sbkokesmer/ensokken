          ...
          {favoriteProducts.map(product => (
            <div key={product.id} className="group flex flex-col h-full relative">
              <button
                ...
                className="absolute top-3 right-3 z-20 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-sm text-black hover:bg-zinc-50 transition-colors"
              ...
              >
                Bekijk Product <ShoppingBag width={14} height={14} />
              </Link>
            </div>
          ))}
        </div>
