...
export default function ProductClient({ product }: ProductClientProps) {
  ...
  // İlk yüklemede varsayılan renk ve resmi ayarla
  useEffect(() => {
    if (product) {
  ...
  const handleColorChange = (color: string) => {
    ...
    if (colorIndex !== -1 && product.gallery[colorIndex]) {
      setCurrentImage(product.gallery[colorIndex]);
    }
  };
          ...
          <div className="lg:col-span-5 flex flex-col h-full">
              <div className="sticky top-24">
                <div className="mb-6">
                  ...
                  <p className="text-3xl font-medium text-black">{product.price}</p>
                </div>
